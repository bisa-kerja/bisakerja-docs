...
- [Raw Payload Contract](../references/raw-payload-contract.mdx)
- [Source Field Mapping Matrix](../references/source-field-mapping-matrix.mdx)
- [Backend Sync Schema Map](../references/backend-sync-schema-map.mdx)
- [AI Normalization Prompt Contract](../references/ai-normalization-prompt.mdx)
