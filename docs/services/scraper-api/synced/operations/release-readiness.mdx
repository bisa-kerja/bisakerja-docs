...
Use [Production Readiness Gate](./production-readiness-gate.mdx) for final go/no-go thresholds, decision record, approval record, and first-run execution procedure.
